...
<template>
  <div class="hd-w">
    ...
    <nav class="nav-container" @click="handleNav($event)">
      ...
      <div class="logo-wrap">
        <img src="/logo.svg" data-index="home" title="" />
      </div>
    ...
    <SettingView />
    <footer>
      Copyright ©2022-{{ timeE }} <a style="text-decoration : none" href="https://u.mr90.top" target="_blank"
        rel="noopener noreferrer">Tsuki</a>
    </footer>
  </div>
</template>
